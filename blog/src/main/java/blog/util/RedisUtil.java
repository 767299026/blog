...
public class RedisUtil {
     ...
     * @return
     */
    public double hashincrement(String key, Object item, double by) {
     ...
     * @return
     */
    public double hashdecrement(String key, Object item, double by) {
        return redisTemplate.opsForHash().increment(key, item, -by);
    }
     ...
     * @return true 存在 false不存在
     */
    public boolean selectHasKey(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean listSetMIn(String key, Object value) {
        try {
     ...
     * @return
     */
    public Object listPop(String key, long index) {
        try {
            return redisTemplate.opsForList().leftPop(key, index, TimeUnit.SECONDS);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
