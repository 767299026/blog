<template>
  <div class="card">
    ...
    <p style="margin-top: 0px;">Welcome to YIQU's Blog</p>
    <div>
      <p style="margin-left: 20px; margin-top:60px;margin-bottom:0px;font-size: 16px;font-family: 宋体;font-weight: bold;">
        每日学习中</p>
      <p style="margin-left: 20px; margin-top:5px;font-size:16px;font-family: 宋体;font-weight: bold;">很高兴和你交流</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    getRunTime() {
      var birthDay = this.NewDate("2022-02-06");
      var today = new Date();
