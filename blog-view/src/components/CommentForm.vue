  ...
  methods: {
    ...
    onInputBlur() {
      ...
      if (!isNaN(Number(qq)) && qq.length > 4 && qq.length < 12) {
        ...
        this.commentForm.avatar = "http://cdn.xian-yun.xyz/static/blog/avatar/" + randomNum + ".jpg"
      ...
      this.$refs.formRef.validate((valid) => {
        if (valid) {
          ...
          if (this.commentForm.isAdminComment == 1) {
            this.commentForm.avatar = "https://cdn.jsdelivr.net/gh/767299026/CDN/blog/MyHeadPortrait.webp"
          }
          const _this = this
